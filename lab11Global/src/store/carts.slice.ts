import {createAsyncThunk, createSlice, PayloadAction} from '@reduxjs/toolkit';import {defaultSearchOptions, ICart, ISearchOptions} from "../intefaces/commonInterfaces";
